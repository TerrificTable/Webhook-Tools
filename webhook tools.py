...
# yo @Elektronomia kannst du mal einen webhook erstellen (am besten einfach mit dem namen test oder so) und mir den link per dm senden möchte dir was zeigen
import colorama
import requests
import time
import os
